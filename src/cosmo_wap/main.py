...
class ClassWAP:
    ...
    def __init__(self,cosmo,survey_params=None,compute_bias=False,HMF='Tinker2010',emulator=False,verbose=True,params=None,fast=False,nonlin=False):
        ...
        self.term_list = ['NPP','RR1','RR2','WA1','WA2','WAGR','WS','WAGR','RRGR','WSGR','Full','GR1','GR2','GRX','Loc','Eq','Orth','IntInt','IntNPP','GRI','GRL','GR'] + intcomponents # list of terms currently implemented. Does not include composites - see pk/combined.py etc
