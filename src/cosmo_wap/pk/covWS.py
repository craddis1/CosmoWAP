...
class cov_NPP:
    @staticmethod
    def l00(cf_mat,t1,t2,t3,t4,k1,zz=0):
        Pk,f,D1,b1,b11 = cf_mat[t1][t2].unpack_pk(k1,zz)
        _,_,_,b12,b13 = cf_mat[t3][t4].unpack_pk(k1,zz)

        n13 = 1/cf_mat[t1][t3].n_g(zz)
        n14 = 1/cf_mat[t1][t4].n_g(zz)
        n23 = 1/cf_mat[t2][t3].n_g(zz)
        n24 = 1/cf_mat[t2][t4].n_g(zz)
...
class cov_WA2:
    @staticmethod
    def l00(cf_mat,t1,t2,t3,t4,k1,zz=0):
        Pk,f,D1,b1,b11,Pkd,Pkdd,d = cf_mat[t1][t2].unpack_pk(k1,zz,WS=True)
        _,_,_,b12,b13 = cf_mat[t3][t4].unpack_pk(k1,zz)
    ...
    @staticmethod
    def l11(cf_mat,t1,t2,t3,t4,k1,zz=0):
        Pk,f,D1,b1,b11,Pkd,Pkdd,d = cf_mat[t1][t2].unpack_pk(k1,zz,WS=True)
        _,_,_,b12,b13 = cf_mat[t3][t4].unpack_pk(k1,zz)
