...
class IntRSD(BaseInt):
    ...
    def l0_integrand(xd,cosmo_funcs, k1, zz=0, t=0, sigma=None):
        ...
        expr = (3 * D1 * D1d * Hd**2 * OMd * (-1j * G_expr(xd) ** 3 * Hd * b1 * k1**2 * (d - xd) ** 3 * (fd - 1) * (4 * H * (Qm - 1) + d * (3 * OM - 4 * Qm + 2 * be - 2)) * (np.exp(2 * 1j * k1 * (d - xd) / G_expr(xd)) - 1) * np.exp(-1j * k1 * (d - xd) / G_expr(xd)) + G_expr(xd) ** 3 * Hd * f * (d - xd) * (fd - 1) * (4 * H * (Qm - 1) + d * (3 * OM - 4 * Qm + 2 * be - 2)) * (2 * 1j * G_expr(xd) ** 2 * (np.exp(2 * 1j * k1 * (d - xd) / G_expr(xd)) - 1) + 2 * G_expr(xd) * k1 * (d - xd) * (np.exp(2 * 1j * k1 * (d - xd) / G_expr(xd)) + 1) - 1j * k1**2 * (d - xd) ** 2 * (np.exp(2 * 1j * k1 * (d - xd) / G_expr(xd)) - 1)) * np.exp(-1j * k1 * (d - xd) / G_expr(xd)) - 4 * 1j * G_expr(xd) ** 3 * b1 * k1**2 * (Qm - 1) * (d - xd) ** 3 * (np.exp(2 * 1j * k1 * (d - xd) / G_expr(xd)) - 1) * np.exp(-1j * k1 * (d - xd) / G_expr(xd)) + 4 * G_expr(xd) ** 3 * f * (Qm - 1) * (d - xd) * (2 * 1j * G_expr(xd) ** 2 * (np.exp(2 * 1j * k1 * (d - xd) / G_expr(xd)) - 1) + 2 * G_expr(xd) * k1 * (d - xd) * (np.exp(2 * 1j * k1 * (d - xd) / G_expr(xd)) + 1) - 1j * k1**2 * (d - xd) ** 2 * (np.exp(2 * 1j * k1 * (d - xd) / G_expr(xd)) - 1)) * np.exp(-1j * k1 * (d - xd) / G_expr(xd)) + 4 * G_expr(xd) ** 2 * b1 * k1**2 * (Qm - 1) * (d - xd) ** 3 * (1j * G_expr(xd) * (np.exp(2 * 1j * k1 * (d - xd) / G_expr(xd)) - 1) + k1 * (d - xd) * (np.exp(2 * 1j * k1 * (d - xd) / G_expr(xd)) + 1)) * np.exp(-1j * k1 * (d - xd) / G_expr(xd)) - 2 * 1j * G_expr(xd) * b1 * k1**4 * xd * (Qm - 1) * (d - xd) ** 4 * (np.exp(2 * 1j * k1 * (d - xd) / G_expr(xd)) - 1) * np.exp(-1j * k1 * (d - xd) / G_expr(xd)) + 2 * G_expr(xd) * b1 * k1**2 * xd * (Qm - 1) * (d - xd) ** 2 * (-2 * 1j * G_expr(xd) ** 2 * (np.exp(2 * 1j * k1 * (d - xd) / G_expr(xd)) - 1) - 2 * G_expr(xd) * k1 * (d - xd) * (np.exp(2 * 1j * k1 * (d - xd) / G_expr(xd)) + 1) + 1j * k1**2 * (d - xd) ** 2 * (np.exp(2 * 1j * k1 * (d - xd) / G_expr(xd)) - 1)) * np.exp(-1j * k1 * (d - xd) / G_expr(xd)) + 2 * G_expr(xd) * f * k1**2 * xd * (Qm - 1) * (d - xd) ** 2 * ( 2 * 1j * G_expr(xd) ** 2 * (np.exp(2 * 1j * k1 * (d - xd) / G_expr(xd)) - 1) + 2 * G_expr(xd) * k1 * (d - xd) * (np.exp(2 * 1j * k1 * (d - xd) / G_expr(xd)) + 1) - 1j * k1**2 * (d - xd) ** 2 * (np.exp(2 * 1j * k1 * (d - xd) / G_expr(xd)) - 1)) * np.exp(-1j * k1 * (d - xd) / G_expr(xd)) - 4 * 1j * G_expr(xd) * f * (1 - Qm) * (d - xd) * (6 * G_expr(xd) ** 4 - G_expr(xd) * (6 * G_expr(xd) ** 3 + 6 * 1j * G_expr(xd) ** 2 * k1 * (-d + xd) - 3 * G_expr(xd) * k1**2 * (d - xd) ** 2 + 1j * k1**3 * (d - xd) ** 3) * np.exp(1j * k1 * (d - xd) / G_expr(xd)) - G_expr(xd) * (6 * G_expr(xd) ** 3 * (np.exp(1j * k1 * (d - xd) / G_expr(xd)) - 1) - 6 * 1j * G_expr(xd) ** 2 * k1 * (d - xd) + 3 * G_expr(xd) * k1**2 * (d - xd) ** 2 + 1j * k1**3 * (d - xd) ** 3) * np.exp(-1j * k1 * (d - xd) / G_expr(xd))) + 2 * f * xd * (1 - Qm) * (24 * 1j * G_expr(xd) ** 5 + G_expr(xd) * (-24 * 1j * G_expr(xd) ** 4 - 24 * G_expr(xd) ** 3 * k1 * (d - xd) + 12 * 1j * G_expr(xd) ** 2 * k1**2 * (d - xd) ** 2 + 4 * G_expr(xd) * k1**3 * (d - xd) ** 3 - 1j * k1**4 * (d - xd) ** 4) * np.exp(1j * k1 * (d - xd) / G_expr(xd)) + G_expr(xd) * (-24 * 1j * G_expr(xd) ** 4 * (np.exp(1j * k1 * (d - xd) / G_expr(xd)) - 1) - 24 * G_expr(xd) ** 3 * k1 * (d - xd) - 12 * 1j * G_expr(xd) ** 2 * k1**2 * (d - xd) ** 2 + 4 * G_expr(xd) * k1**3 * (d - xd) ** 3 + 1j * k1**4 * (d - xd) ** 4) * np.exp(-1j * k1 * (d - xd) / G_expr(xd)))) * cosmo_funcs.Pk(k1 / G_expr(xd)) / (G_expr(xd) ** 3 * d * k1**5 * (d - xd) ** 4))
        return expr
...
class IntInt(BaseInt):
    ...
    def l0_integrand(xd1, xd2, cosmo_funcs, k1, zz, t=0, sigma=None):
        ...
        def int_terms2(xd1, cosmo_funcs, k1, zz, t=0, sigma=None):
            ...
            expr = D1d1*D1d1*Hd1**2*Hd1**2*OMd1*OMd1*(45*G_expr(xd1, xd1, d)**4*(-2*H**2*(Qm - 1) - Hd1*(fd1 - 1)*(H**2*d*(-2*Qm + be) + 2*H*(Qm - 1) - Hp*d))*(-2*H**2*(Qm - 1) - Hd1*(fd1 - 1)*(H**2*d*(-2*Qm + be) + 2*H*(Qm - 1) - Hp*d)) + 60*G_expr(xd1, xd1, d)**2*H**4*k1**2*(Qm - 1)**2*(d - xd1)*(d - xd1) + 10*G_expr(xd1, xd1, d)**2*H**2*k1**2*xd1*(3 - 3*Qm)*(d - xd1)*(-2*H**2*(Qm - 1) - Hd1*(fd1 - 1)*(H**2*d*(-2*Qm + be) + 2*H*(Qm - 1) - Hp*d)) + 10*G_expr(xd1, xd1, d)**2*H**2*k1**2*xd1*(3 - 3*Qm)*(d - xd1)*(-2*H**2*(Qm - 1) - Hd1*(fd1 - 1)*(H**2*d*(-2*Qm + be) + 2*H*(Qm - 1) - Hp*d)) + 24*H**4*k1**4*xd1*xd1*(Qm - 1)**2*(d - xd1)*(d - xd1))*cosmo_funcs.Pk(k1/G_expr(xd1, xd1, d))/(5*H**4*d**2*k1**4)
            return expr
