...
class K1:
    ...
    def I(r,cosmo_funcs,zz=0,mu=None,k1=None,ti=0):
    ...
    @staticmethod
    def kappa_g(r,cosmo_funcs,zz=0,mu=None,k1=None,ti=0): # so could define in a new class but then need to update with choice in pk_int
